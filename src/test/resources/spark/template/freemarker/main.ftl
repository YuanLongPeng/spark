  ...
  <div>
    <div class="actions">
      <router-link class="btn btn-default" v-bind:to="{path: '/add-product'}">
    	...
    	<a class="btn btn-default" :href="'/interest'">Edit Interest</a>
    	<a class="btn btn-default" :href="'/theme'">Edit Theme</a>
    ...
    <table class="table">
      ...
      <tr v-for="product in filteredProducts">
        <td>
          <a :href="'/senctence?diaryId='+product.name">{{ product.name }}</a>
        </td>
...
<script src='https://cdnjs.cloudflare.com/ajax/libs/vue/2.1.10/vue.js'></script><script src='https://cdnjs.cloudflare.com/ajax/libs/vue-router/2.2.1/vue-router.js'></script>
<script src="https://cdn.jsdelivr.net/npm/vue-resource@0.9.3"></script>
<script >var products = [
<#list message as m>
	{id: 1, name: '${m}', description: 'Superheroic JavaScript MVW Framework.', price: 100} ${(m?index == (message?size - 1))?then("", ",")}
</#list>
];
...
var AddProduct = Vue.extend({
  ...
  methods: {
    createProduct: function() {
      ...
      Vue.http.post('/diary', {'diary': product.name}, {emulateJSON: true})
  		.then ((res)=> {
