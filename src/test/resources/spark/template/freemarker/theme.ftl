...
<div class="container">
  <header class="page-header">
    <div class="branding">
      <a href="/main"><img src="https://vuejs.org/images/logo.png" alt="Logo" title="Home page" class="logo"/></a>
      <h1>Theme</h1>
  ...
  <div>
    ...
    <div class="filters row">
      <div class="form-group col-sm-3">
        <label for="search-element">Theme</label>
  ...
  <div>
    ...
    <form v-on:submit="createProduct">
      <div class="form-group">
        <label for="add-name">Theme</label>
...
<script >var products = [
<#list message as m>
	{id: '${m?index}', name: '${m}'} ${(m?index == (message?size - 1))?then("", ",")}
</#list>
];
...
var AddProduct = Vue.extend({
  ...
  methods: {
    createProduct: function() {
      ...
      Vue.http.post('/theme', {'title': product.name}, {emulateJSON: true})
  		.then ((res)=> {
